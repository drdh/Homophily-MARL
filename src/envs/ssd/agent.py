...
class Agent(object):
    ...
    def get_state_from_rgb(self, rgb): # [X,Y,3]
        return util.return_view(rgb, self.get_pos(),
                                self.row_size, self.col_size, pad_rgb=True)
...
class HarvestAgent(Agent):
    ...
    def __init__(self, agent_id, start_pos, start_orientation, grid, view_len=HARVEST_VIEW_SIZE):
        self.view_len = view_len                                      # row_size, col_size
